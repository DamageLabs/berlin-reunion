  ...
  return (
    <div className="w-full max-w-sm space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {showVerifyPrompt && (
          <div className="rounded-md border border-gold-dark/30 p-3 space-y-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-md border border-gold-dark/30 bg-charcoal-light px-3 py-1.5 text-sm text-cream focus:border-gold focus:outline-none"
              />
              <button
                type="button"
                onClick={() => {
                ...
                className="rounded-md bg-gold px-3 py-1.5 text-sm font-medium text-charcoal hover:bg-gold-dark"
              >
                Verify
              </button>
            </div>
