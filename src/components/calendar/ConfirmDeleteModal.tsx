...
export default function ConfirmDeleteModal({
	...
	return (
		<ModalOverlay open={true} onClose={onCancel} panelClassName="w-full max-w-sm">
			{(labelId) => (
				<>
					<h3
						id={labelId}
						className="font-[family-name:var(--font-oswald)] text-lg font-semibold uppercase tracking-wider text-gold"
					>
						Delete Event
					</h3>
